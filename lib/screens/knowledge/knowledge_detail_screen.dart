                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('File "$_selectedFileName" has been uploaded to "${widget.item.title}"'),
                    ],
                  ),
                ),
              ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Website "$unitName" has been added to "${widget.item.title}"'),
                    ],
                  ),
                ),
              ],
                    ...
                    SnackBar(
                      content: Row(
                        children: [
                          ...
                          SizedBox(width: 16),
                          Expanded(
                            child: Text('Knowledge source "${item.title}" has been deleted'),
                          ),
                        ],
                      ),
                      backgroundColor: Colors.green,
